return {
    ...
    ["Black Chocobo Fletchings Batch"] = {
        ["crystal"] = "Wind Crystal",
        ["ingredients"] = {
            "Black C. Feather",
            "Black C. Feather",
